...
function UpdatePromotionProduct() {
    ...
    const { isLoading, data, isError, error } = useGetPromotionProductData(id);
    ...
    const { mutate: updatePromotionProduct } = useUpdatePromotionProductData(onSuccess);
    const onSubmit = async (data) => {
        ...
        updatePromotionProduct(dataPromotionProduct);
    };
            ...
            <>
                <div className="card shadow mb-4">
                    <div className="card-header py-3">
                        <h6 className="m-0 font-weight-bold text-primary">Cập nhật khuyến mãi</h6>
                    </div>
...
export default UpdatePromotionProduct;
