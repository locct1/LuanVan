...
function UpdateAccessory() {
    ...
    useEffect(() => {
        if (data && dataProductCategories && dataProductCategories.data) {
            ...
            setFormattedPriceOut(convertproductVersionsedOptions[0].formattedPriceOut);
            setFormattedPriceIn(convertproductVersionsedOptions[0].formattedPriceIn);
            setSelectedOption(convertedOptions);
            setProductVersion(convertproductVersionsedOptions[0]);
            ...
            setValue('jackPlugId', data.data.jackPlugId);
            setValue('chargerPortId', data.data.chargerPortId);
            setValue('charging', data.data.charging);
            setValue('priceIn', convertproductVersionsedOptions[0].priceIn);
            setValue('priceOut', convertproductVersionsedOptions[0].priceOut);
            setValue('colorproducts', convertedOptions);
            setValue('productCategoryId', data.data.productCategoryCode);
            setValue('headPhoneTime', data.data.headPhoneTime);
            ...
            let productCategory = dataProductCategories.data.find(
                (productCategory) => productCategory.code === data.data.productCategoryCode,
            );
    ...
    const { mutate: updateAccessory } = useUpdateAccessoryData(onSuccess);
    ...
    const onSubmit = async (data) => {
        ...
        formData.append('productVersionId', productVersion.id);
